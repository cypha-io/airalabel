  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 md:px-8 md:py-16">
      <div className="mb-10 flex flex-col items-center md:mb-14">
        <span className="mb-2 text-xs font-black uppercase tracking-[0.2em] text-black md:text-sm">Trending Now</span>
        <h2 className="text-3xl font-black tracking-tight text-gray-800 md:text-4xl lg:text-5xl">Popular Items</h2>
