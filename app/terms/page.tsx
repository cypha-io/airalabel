        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing and using Airalabel&apos;s services, you accept and agree to be bound by these Terms and Conditions. If you do not agree, please do not use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Airalabel is not liable for any indirect, incidental, or consequential damages arising from the use of our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              For questions about these Terms & Conditions, contact us at info@airalabel.com or +233 XX XXX XXXX.
            </p>
          </section>
        </div>
      </main>
